                    ...
                    {isAuthor && (
                        <div className="absolute right-6 top-6">
                            <Link to={`/edit-post/${post.$id}`}>
                                <Button bgColor="bg-green-500" hover="hover:bg-green-700 hover:text-white" className="mr-3 rounded-lg">
                                    Edit
                                </Button>
                            </Link>
                            <Button bgColor="bg-red-500" className="rounded-lg" hover="hover:bg-red-700 hover:text-white" onClick={deletePost}>
                                Delete
                            </Button>
                        </div>
                    )}
